...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests()
                ...
                .requestMatchers(HttpMethod.POST, "/api-sirep/user/actualizar/password").permitAll()
                .requestMatchers(HttpMethod.GET, "/api-sirep/user/email/{email}").permitAll()
                .requestMatchers(HttpMethod.POST, "/api-sirep/user/actualizar/code").permitAll()
